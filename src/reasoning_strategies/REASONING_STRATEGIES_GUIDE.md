...
```python
from src.reasoning_strategies import StrategyRegistry, initialize_strategies, StrategyConfig, StrategyType
...
```python
from src.reasoning_strategies import ZeroOutLRHeuristic, StrategyConfig, StrategyType
