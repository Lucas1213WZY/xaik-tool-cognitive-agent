...
class CRAgentRunner:
    ...
    def _load_counterfactual_strategies(self) -> Dict[str, Any]:
        """Load counterfactual reasoning strategies from reasoning_strategies layer."""
        from .agents import create_counterfactual_strategies
        
        # Create wrapped counterfactual strategies from reasoning_strategies layer
