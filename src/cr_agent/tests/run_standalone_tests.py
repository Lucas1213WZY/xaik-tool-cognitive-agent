...
def test_module_imports():
    ...
    try:
        from src.cr_agent.headless_policies import (
            HeadlessDTPolicy,
            HeadlessLRCalcPolicy,
            HeadlessLRHeurPolicy,
        )
        from src.cr_agent.forward_meta_router import (
            load_forward_strategies,
            run_meta_on_batch,
        )
        from src.cr_agent.counterfactual_meta_router import (
            CounterfactualMetaRouter,
            load_counterfactual_strategies,
        )
        from src.cr_agent.interface import CRAgentRunner, MetaRunner
        from src.cr_agent.registry import (
...
def test_strategy_factory():
    ...
    try:
        from src.cr_agent.counterfactual_meta_router import load_counterfactual_strategies
        ...
        # Verify each strategy has reasoning_strategies API methods
        ...
        print("✅ All strategies loaded from reasoning_strategies API")
        return True
...
def test_forward_strategy_loading():
    ...
    try:
        from src.cr_agent.forward_meta_router import load_forward_strategies
        ...
        print("✅ All forward strategies load from reasoning_strategies API")
