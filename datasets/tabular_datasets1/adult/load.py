...
def load_data(**kwargs):
    ...
    feature_names = ["Age", "Workclass", "fnlwgt", "Education",
                             "Years of Education", "Married", "Occupation",
    ...
    # change column names of Martial status to Married
    X = X.rename(columns={"Marital Status": "Married"})
    ...
    dataset = TabularDataset(X_numpy, y_numerical, feature_names=feature_names,\
        ...
        target_options=["Type 1", "Type 2"], dataset_name="adult")
