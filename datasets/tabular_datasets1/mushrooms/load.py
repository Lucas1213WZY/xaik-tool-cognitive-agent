...
def load_data(**kwargs):
    ...
    df = df[df['gill-spacing'].isin(['d', 'f'])]
    print(f"Remaining rows after filtering 'gill-spacing' to 'd' or 'f': {len(df)}")
    ...
    rename_mappings = {
        ...
        'gill-spacing': {'c': 'close', 'f': 'no', 'd': 'yes',}
    }
    ...
    categorical_features = ["Shape", "cap-surface", "cap-color", "Bruises", "gill-attach", "Gill",
