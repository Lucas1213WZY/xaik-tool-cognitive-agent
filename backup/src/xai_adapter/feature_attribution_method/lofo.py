"""Leave-one-feature-out attribution method."""
...
class LOFOMethod(XAIAdapter):
    """Local leave-one-feature-out method with a sklearn-like fit/explain API."""
    ...
    def fit(self, X: ArrayLike, y: ArrayLike = None, **kwargs):
        """Fit the baseline from background data."""
