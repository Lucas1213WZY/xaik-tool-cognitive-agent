...
workflow with:
  ...
  - src.reasoning_strategies for strategy instantiation and inference
  - fitted participant cognitive parameters from assets/param_config
...
DEFAULT_COAX_PARAMS_PATH = DEFAULT_ASSETS_ROOT / "param_config" / "CoAX_cog_param.csv"
