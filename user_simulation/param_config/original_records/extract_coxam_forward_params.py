...
def extract_coxam_forward_params():
    ...
    input_file = 'src/user_simulation/param_config/forward_simulation_comparison_v0.4.xlsx'
    output_file = 'src/user_simulation/param_config/CoXAM_forward_simulation_cog_param.csv'
